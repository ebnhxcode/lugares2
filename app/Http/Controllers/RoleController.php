...
class RoleController extends Controller {
   ...
   public function store(Request $request) {
      ...
      $this->validacion = Validator::make($request->all(), [
         'nom_role' => "regex:/(^([a-zA-Z0-9_ áéíóúñÁÉÍÓÚÑ]+)(\d+)?$)/u|required|unique:$this->nombre_tabla|max:255",
         'det_role' => 'regex:/(^([a-zA-Z0-9_ ,.!@#$%*&áéíóúñÁÉÍÓÚÑ]+)(\d+)?$)/u|required|max:1000',
   ...
   public function update(Request $request, $id) {
      ...
      $this->validacion = Validator::make($request->all(), [
         ...
         'nom_role' => 'regex:/(^([a-zA-Z0-9_ áéíóúñÁÉÍÓÚÑ]+)(\d+)?$)/u|required|max:255',
         'det_role' => 'regex:/(^([a-zA-Z0-9_ ,.!@#$%*&áéíóúñÁÉÍÓÚÑ]+)(\d+)?$)/u|required|max:1000',
