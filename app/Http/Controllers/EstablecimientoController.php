 ...
 * */
   ...
   public function store(Request $request) {
      ...
      $this->new_establecimiento = Establecimiento::create([
         ...
         'dominio_email' => $this->establecimiento['dominio_email'],
   ...
   public function update(Request $request, $id) {
      ...
      $this->validacion = Validator::make($request->all(), [
         ...
         'dominio_email' => "regex:/(^([a-zA-Z0-9_ ,.!@#$%*&áéíóúñÁÉÍÓÚÑ]+)(\d+)?$)/u|max:255",
         'cod_area_fax' => "nullable|regex:/(^([0-9]+)(\d+)?$)/u|max:255",
         'fax' => "nullable|regex:/(^([a-zA-Z0-9_ ,.!@#$%*&áéíóúñÁÉÍÓÚÑ]+)(\d+)?$)/u|max:255",
         'ext_horaria' => "regex:/(^([a-z]+)(\d+)?$)/u|max:255",
         'vigencia_desde' => "regex:/(^([a-zA-Z0-9_ ,.!@#$%*&áéíóúñÁÉÍÓÚÑ]+)(\d+)?$)/u|max:255",
         #'fecha_cierre' => "regex:/(^([a-zA-Z0-9_ ,.!@#$%*&áéíóúñÁÉÍÓÚÑ]+)(\d+)?$)/u|max:255",
         #'id_establecimiento_antiguo' => "regex:/(^([a-zA-Z0-9_ ,.!@#$%*&áéíóúñÁÉÍÓÚÑ]+)(\d+)?$)/u|max:255",
