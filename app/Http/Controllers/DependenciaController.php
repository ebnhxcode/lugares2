...
class DependenciaController extends Controller {
   ...
   public function __construct () {
      ...
      $this->nombre_controller = "DependenciaController";
   }
   ...
   public function index_ajax (Request $request) {
      if ($request->wantsJson() && $request->ajax() && $request->isXmlHttpRequest()) {
         ...
         $this->dependencias = Dependencia::paginate((int)$this->per_page);
   ...
   public function show (Request $request, $id) {
      ...
      $this->dependencia = Dependencia::where("id_$this->nombre_modelo",'=',$id)->first();
   ...
   public function store(Request $request) {
      ...
      $this->validacion = Validator::make($request->all(), [
         ...
         'det_dependencia' => "nullable|regex:/(^([a-zA-Z0-9_ ,.!@#$%*&-áéíóúñÁÉÍÓÚÑ]+)(\d+)?$)/u|max:255",
      ]);
      ...
      unset($this->dependencia, $this->validacion);
      ...
      return response()->json([
         ...
         //Para mostrar los mensajes que van desde el backend
         'dependencia' => $this->new_dependencia
      ]);
   }
   ...
   public function update(Request $request, $id) {
      ...
      $this->dependencia = Dependencia::find($request["id_$this->nombre_modelo"]);
      $request['id_usuario_modifica'] = Auth::user()->id_usuario;
      $this->dependencia->update($request->all());

      #unset($this->new_dependencia_permiso, $this->permiso);
      return response()->json([
         'status' => 200, //Para los popups con alertas de sweet alert
   ...
   public function destroy($id) {
      ...
      #Valida si dependencia existe y busca si tiene dependencia_permiso
      if ($this->dependencia) {
