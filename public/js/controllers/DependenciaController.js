...
var DependenciaController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['nom_dependencia', 'det_dependencia'],
         'relaciones_clase': [],
         'lom': {},
         'lista_objs_model': [],
         'dependencias': [],
         ...
         'tabla_campos': {
            'id_dependencia': { 'visibility': false, 'value': null },
            'nom_dependencia': { 'visibility': true, 'value': null },
            'det_dependencia': { 'visibility': false, 'value': null },
   ...
   watch: {
      ...
      dependencias: function dependencias(_dependencias) {
         var self = this;
         this.excel_json_datos = [];
         return _dependencias.map(function (dependencia, index) {
