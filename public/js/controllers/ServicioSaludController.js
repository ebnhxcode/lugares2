...
var ServicioSaludController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['nom_servicio_salud', 'det_servicio_salud', 'orden', 'id_region'],
   ...
   watch: {
      ...
      servicios_salud: function servicios_salud(_servicios_salud) {
         var self = this;
         this.excel_json_datos = [];
         return _servicios_salud.map(function (servicio_salud, index) {
