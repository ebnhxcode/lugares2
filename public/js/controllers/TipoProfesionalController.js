...
var TipoProfesionalController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['nom_tipo_profesional', 'det_tipo_profesional'],
         'relaciones_clase': [],
         'lom': {},
         'lista_objs_model': [],
         'tipos_profesionales': [],
   ...
   watch: {
      ...
      tipos_profesionales: function tipos_profesionales(_tipos_profesionales) {
         var self = this;
         this.excel_json_datos = [];
         return _tipos_profesionales.map(function (tipo_profesional, index) {
