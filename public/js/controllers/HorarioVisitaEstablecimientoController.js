...
var HorarioVisitaEstablecimientoController = new Vue({
   ...
   watch: {
      ...
      horarios_visita_establecimientos: function horarios_visita_establecimientos(_horarios_visita_establecimientos) {
         var self = this;
         this.excel_json_datos = [];
         return _horarios_visita_establecimientos.map(function (horario_visita_establecimiento, index) {
