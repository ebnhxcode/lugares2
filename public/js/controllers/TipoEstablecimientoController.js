...
var TipoEstablecimientoController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['nom_tipo_establecimiento', 'det_tipo_establecimiento'],
         'relaciones_clase': [],
         'lom': {},
         'lista_objs_model': [],
   ...
   watch: {
      ...
      tipos_establecimientos: function tipos_establecimientos(_tipos_establecimientos) {
         var self = this;
         this.excel_json_datos = [];
         return _tipos_establecimientos.map(function (tipo_establecimiento, index) {
