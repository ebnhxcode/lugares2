...
var OrganismoController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['nom_organismo', 'det_organismo', 'cod_organismo', 'id_tipo_organismo'],
         'relaciones_clase': [{ 'organismo': ['id_tipo_organismo', 'nom_tipo_organismo'] }],
         'lom': {},
         'lista_objs_model': [],
         'organismos': [],
         'tipos_organismos': [],
   ...
   watch: {
      ...
      organismos: function organismos(_organismos) {
         var self = this;
         this.excel_json_datos = [];
         return _organismos.map(function (organismo, index) {
