...
var ProfesionalController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['nom_profesional', 'det_profesional', 'id_tipo_profesional', 'id_cargo', 'id_estado'],
         'relaciones_clase': [{ 'tipo_profesional': ['id_tipo_profesional', 'nom_tipo_profesional'] }, { 'cargo': ['id_cargo', 'nom_cargo'] }, { 'estado': ['id_estado', 'nom_estado'] }],
         'lom': {},
         'lista_objs_model': [],
         'profesionales': [],
         'tipos_profesionales': [],
   ...
   watch: {
      ...
      profesionales: function profesionales(_profesionales) {
         var self = this;
         this.excel_json_datos = [];
         return _profesionales.map(function (profesional, index) {
