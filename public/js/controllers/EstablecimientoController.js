...
var EstablecimientoController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['nom_establecimiento', 'tipo_establecimiento', 'observaciones', 'nom_direccion', 'nom_responsable', 'sitio_web', 'email', 'fax', 'vigencia_desde', 'fecha_cierre', 'id_establecimiento_antiguo', 'id_tipo_establecimiento', 'id_servicio_salud', 'id_dependencia', 'id_organismo', 'id_region', 'id_comuna'],
