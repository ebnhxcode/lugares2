...
var TipoOrganismoController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['nom_tipo_organismo', 'det_tipo_organismo'],
         'relaciones_clase': [],
         'lom': {},
         'lista_objs_model': [],
         'tipos_organismos': [],
         ...
         'tabla_campos': {
            'id_tipo_organismo': { 'visibility': false, 'value': null },
            'nom_tipo_organismo': { 'visibility': true, 'value': null },
            'det_tipo_organismo': { 'visibility': false, 'value': null },
   ...
   watch: {
      ...
      tipos_organismos: function tipos_organismos(_tipos_organismos) {
         var self = this;
         this.excel_json_datos = [];
         return _tipos_organismos.map(function (tipo_organismo, index) {
