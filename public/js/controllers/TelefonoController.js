...
var TelefonoController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['num_telefono', 'det_telefono', 'cod_area', 'id_tipo_telefono', 'id_establecimiento'],
         'relaciones_clase': [{ 'tipo_telefono': ['id_tipo_telefono', 'nom_tipo_telefono'] }, { 'establecimiento': ['id_establecimiento', 'nom_establecimiento'] }],
         'lom': {},
         'lista_objs_model': [],
         'telefonos': [],
         'tipos_telefonos': [],
   ...
   watch: {
      ...
      telefonos: function telefonos(_telefonos) {
         var self = this;
         this.excel_json_datos = [];
         return _telefonos.map(function (telefono, index) {
            return self.excel_json_datos.push({
               ...
               'id_establecimiento': telefono.id_establecimiento || '-',
               'nom_establecimiento': telefono.nom_establecimiento || '-',
