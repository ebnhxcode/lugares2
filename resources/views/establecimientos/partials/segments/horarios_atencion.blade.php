   ...
   <div class="col-sm-6 col-md-6">
      <div class="row">
         ...
         <div class="col-sm-3 col-md-3">
            ...
            <dd>
               <p class="control has-icon has-icon-right">
                  <input type="time" v-model="horario_atencion_establecimiento.hora_inicio" name="hora_inicio"
         ...
         <div class="col-sm-3 col-md-3">
            ...
            <dd>
               <p class="control has-icon has-icon-right">
                  <input type="time" v-model="horario_atencion_establecimiento.hora_termino" name="hora_termino"
                         v-validate="{required:true,regex:/^[0-9_ :]+$/i}" data-vv-delay="500"
                         class="form-control"/>
