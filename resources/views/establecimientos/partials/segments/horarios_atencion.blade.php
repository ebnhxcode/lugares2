         ...
         <div class="col-sm-10 col-md-10">
            ...
            <dd>
               <p class="control has-icon has-icon-right">
                  ...
                  <transition name="bounce">
                     <i v-show="errors.has('obs_atencion_establecimiento')" class="fa fa-exclamation-circle"></i>
                  </transition>

                  <transition name="bounce">
               <span v-show="errors.has('obs_atencion_establecimiento')" class="text-danger small">
                  @{{ errors.first('obs_atencion_establecimiento') }}
               </span>
                  </transition>
               </p>
